...
public class MaterialSearchView extends FrameLayout implements Filter.FilterListener {
    ...
    private boolean isViewRequested = true;
    ...
    private void initiateView() {
        ...
        mSearchSrcTextView.setImeOptions(EditorInfo.IME_FLAG_NO_EXTRACT_UI);
    ...
    public void setSuggestions(String[] suggestions) {
        if (suggestions != null && suggestions.length > 0) {
            ...
            final CustomSearchAdapter adapter = new CustomSearchAdapter(mContext, suggestions, suggestionIcon, ellipsize);
            setAdapter(adapter);
        } else {
    ...
    public void showSearch() {
        showSearch(true, isViewRequested);
    }
     ...
     */
    public void showSearch(boolean animate, boolean viewRequest) {
        if (isSearchOpen()) {
            return;
        }
        ...
        if (viewRequest) {
            ...
            this.postDelayed(() -> showKeyboard(mSearchSrcTextView), 200);
        }
    ...
    public Parcelable onSaveInstanceState() {
        ...
        mSavedState.isViewRequested = this.isViewRequested;
    ...
    public void onRestoreInstanceState(Parcelable state) {
        ...
        if (mSavedState.isSearchOpen) {
            showSearch(false, mSavedState.isViewRequested);
    ...
    static class SavedState extends BaseSavedState {
        ...
        private SavedState(Parcel in) {
            ...
            this.isViewRequested = in.readBoolean();
        }
        ...
        public void writeToParcel(Parcel out, int flags) {
            ...
            out.writeBoolean(isViewRequested);
        }
